  ...
  console.log(stars);
    ...
    <h5 className="card-title">{values.item.title}</h5>
        ...
        <hr/><div className="card-body">
          ...
          <p className="stars">
          {
            stars.map((x)=>(<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
          ...
          <a href="#" className="btn btn-success flex-box"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
